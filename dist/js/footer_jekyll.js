(()=>{document.addEventListener("DOMContentLoaded",function(){let a=`
    ...
    `,t=document.querySelector("footer");t&&t.remove();let o=document.getElementById("footer");o&&(o.innerHTML=a)});})();
